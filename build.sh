...
function build {
    echo "# Build"
    echo "$ java -jar $bob_path --exclude-build-folder $exclude --variant debug build"
    echo ""
    java -jar $bob_path --exclude-build-folder $exclude --variant debug build
}
...
function bundle {
    ...
    arguments="$arguments --exclude-build-folder \"$exclude\""
